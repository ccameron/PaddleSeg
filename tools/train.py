...
def parse_args():
    ...
    parser.add_argument(
        "--do_eval", help="Whether to do evaluation in training.", action="store_true"
    )
    parser.add_argument(
        "--use_vdl",
    ...
    parser.add_argument(
        "--use_ema", help="Whether to ema the model in training.", action="store_true"
    )

    # Runntime params
    parser.add_argument(
        "--resume_model", help="The path of the model to resume training.", type=str
    )
    ...
    # Other params
    parser.add_argument(
        "--seed", help="Set the random seed in training.", default=None, type=int
    )
    parser.add_argument(
        "--precision",
        default="fp32",
